...
const TMap<FGameplayTag, FTBAttributeInfo>& AttributeInfoLibrary::GetAttributeMap()
{
	...
	static const TMap<FGameplayTag, FTBAttributeInfo> Map = {
		...
		{ GameplayTags.Attributes_Aura, FTBAttributeInfo(GameplayTags.Attributes_Aura, FText::FromString("Aura"), FText::FromString("Current Aura level"), 0.f) },
		{ GameplayTags.Attributes_MaxAura, FTBAttributeInfo(GameplayTags.Attributes_MaxAura, FText::FromString("Max Aura"), FText::FromString("Maximum Aura level"), 0.f) },
